...
('site.version', 'Version', '', '1.4.0', '', 'text', 0, 0, 0, 1),
...
('site.favicon_image', 'Favicon image', "A favicon image is displayed to the left of the page title in the browser tab. We recommend using an image with a resolution of 16x16 for favicon image. Please ftp access to replace existing favicon at /www/html/public/favicon.ico with your new one. A common name for a favicon image is 'favicon.ico'.", '', '{"default":"favicon.ico","style_width":"20","extensions":"jpeg,jpg,png,ico"}', 'image', 24, 1, 3, 0),
...
('Pages', 'admin.page.manage', 0, 1, NOW(), NOW(), 'checkbox', 1, 18, ''),
('Hashtags', 'admin.hashtag.manage', 0, 1, NOW(), NOW(), 'checkbox', 1, 19, ''),
('Users', 'admin.user.manage', 0, 1, NOW(), NOW(), 'checkbox', 1, 20, ''),
...
(2, 'Discovery', 'discovery', 1, 0, 1, 0, 0, NULL, 'images/default/menu/discovery.svg', 'internal', '["all"]', 1, 'discovery', 2, NOW(), NOW()),
(3, 'Watch', 'watch', 1, 0, 1, 0, 0, NULL, 'images/default/menu/watch.svg', 'internal', '["all"]', 1, 'watch', 3, NOW(), NOW()),
(4, 'Lists', 'lists', 1, 0, 1, 0, 0, NULL, 'images/default/menu/list.svg', 'internal', '["all"]', 1, 'list', 4, NOW(), NOW()),
(5, 'Bookmarks', 'bookmarks', 1, 0, 1, 0, 0, NULL, 'images/default/menu/bookmark.svg', 'internal', '["all"]', 1, 'bookmark', 5, NOW(), NOW()),
...
(20, 'Media', 'media', 1, 0, 1, 0, 0, NULL, 'images/default/menu/media.svg', 'internal', '["all"]', 1, 'media', 3, NOW(), NOW()),
(21, 'Media', 'media', 2, 0, 1, 0, 0, NULL, 'images/default/menu/media.svg', 'internal', '["all"]', 1, 'media', 3, NOW(), NOW()),
(22, 'Documents', 'documents', 1, 0, 1, 0, 0, NULL, 'images/default/menu/documents.svg', 'internal', '["all"]', 1, 'documents', 4, NOW(), NOW()),
(23, 'Documents', 'documents', 2, 0, 1, 0, 0, NULL, 'images/default/menu/documents.svg', 'internal', '["all"]', 1, 'documents', 4, NOW(), NOW());
...
INSERT INTO `{prefix}report_categories` (`id`, `name`, `is_active`, `order`, `created_at`, `updated_at`) VALUES
(1, 'Other', '1', '1', NOW(), NOW());
...
(33, 5, 'top', 'container', 'Container', NULL, 0, 'ProfileHeaderPage', 'desktop', '["all"]' ,'{}', 1,'' ,NOW(), NOW(), 'shaun_core'),
(34, 5, 'top', 'container', 'Container', NULL, 0, 'ProfileHeaderPage', 'mobile', '["all"]' ,'{}', 1,'' ,NOW(), NOW(), 'shaun_core'),
